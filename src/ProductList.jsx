...
function ProductList() {
    ...
    const totalQuantity = useSelector(state => state.cart.totalQ);
   ...
   const handleContinueShopping = () => {
        var newShowPlants = {};
        Object.entries(addedToCart).forEach(([key]) => {
            const inCart = cart.find(item => item.name === key);
            if (inCart) {
                newShowPlants[key] = true;
            }
        })
        setAddedToCart(newShowPlants);
    setShowCart(false);
  };
        ...
        <div>
            ...
            <div className="tag">
               ...
               <a href="/" style={{textDecoration:'none'}}>
                        <div>
                    <h3 style={{color:'white'}}>Joey's Plants</h3>
                    <i style={{color:'white'}}>Anything Under the Sun</i>
                    </div>
                    </a>
                </div>
                    ...
                    <div className='product-list'>
                        {category.plants.map((plant, plantIndex) => (
                            <div className='product-card' key={plantIndex}>
                                ...
                                {addedToCart[plant.name] ? <button className='product-button.added-to-cart' disabled={true}>Added to Cart</button>
